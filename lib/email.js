// Minimal Resend email client. Same convention as lib/printful.js: raw fetch +
// env-var auth, and a clean no-op when unconfigured so nothing is sent until
// RESEND_API_KEY is provisioned (via `vercel integration add
