...
export const CATALOG = {
  ...
  'Tote Bag': {
    printfulProductId: 84,  // All-Over Print Tote Bag — one size, 3 colors (verified)
  ...
  'Framed Poster': {
    ...
    prices: { '8×10"': '39.00', '11×14"': '49.00', '16×20"': '69.00', '24×36"': '99.00' },
    defaultPrice: '39.00',
  },
  'Metal Print': {
    printfulProductId: 588,  // Glossy Metal Print (in)
    prices: { '8×10"': '45.00', '11×14"': '59.00', '16×20"': '79.00', '24×36"': '119.00' },
    defaultPrice: '45.00',
  },
  'Sticker': {
    printfulProductId: 957,  // Die-Cut Stickers
    prices: { '3×3"': '4.00', '4×4"': '5.00', '5×5"': '6.00' },
    defaultPrice: '4.00',
  },
  'Throw Pillow': {
  ...
  'Jigsaw Puzzle': {
    ...
    prices: { '252 pieces': '29.00', '520 pieces': '35.00' },
    defaultPrice: '29.00',
  },
};
